...
class NodeContext {
    ...
    setNode(node) {
        ...
        if (oldVal != node) {
            ...
            this._binding.queryType = QueryType.Node;
...
export { makeTemplate, fromTemplate, definedNotNull, undefinedOrNull, getIdlName, ATTRIBUTE_TO_IDL_MAP, defaultEmptyFunc, NodeContext, QueryType, Component, AlinaComponent, Document };
